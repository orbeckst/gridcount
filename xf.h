/*
 ...
 functions for writing output and parameters for xfarbe
 ...
 */
extern void xf_append_axes_annotation (FILE *, real x1, real x2, real y1, real y2);
...
/* xfarbe default rainbow colours (it is not easy to find good
   colours---the xfarbe default is already pretty decent)
*/
